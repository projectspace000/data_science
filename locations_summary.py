...
locations.drop(["locationCode1", "County", "siteId", "terminalId", "SiteStartDate", "latitude", "longitude"], inplace = True, axis = 1)
print("Remaining Columns\n")
list(locations.columns.values)

# rename columns using proper name and case
# i need to find the right way to wrap this, toooooo loooong
locations.rename(columns={"Territory3" : "Territory", "FSR2" : "FSR", "storeNumber1" : "Store", "LocationName" : "Location", "addressLine1" : "Address", "city" : "City", "state" : "State", "phoneNumber" : "Phone", "SerialNumber" : "Kiosk", "placement" : "Placement"}, inplace=True)
